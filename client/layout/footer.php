...
<div class="blog-area pb-55">
    <div class="container">
        <div class="section-title text-center mb-55 mt-5">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-4 col-sm-4">
                <div class="copyright mb-30">
                    ...
                    <p>© 2023 <a href="#">LAPDTECH</a>.<br> All Rights Reserved</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-4">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="footer-widget mb-30 ml-70">
                    ...
                    <div class="subscribe-style">
                        <p>Đăng Ký Email để nhận thông tin về các sản phẩm mới của chúng tôi</p>
                        <div id="mc_embed_signup" class="subscribe-form">
                            <form id="mc-embedded-subscribe-form" class="validate" novalidate="" target="_blank" name="mc-embedded-subscribe-form" method="post" action="https://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef">
                                <div id="mc_embed_signup_scroll" class="mc-form">
                                    <input class="email" type="email" required="" placeholder="Nhập email..." name="EMAIL" value="">
